...
{
	int id = 0, idx;
	vertices * v = (vertices *) malloc(sizeof(struct vertices) * num); // aloca espaço para criar a lista de vertices
...
void busca_Local(vertices * lista_vertices, int tam, int num_cor){
    ...
    buckets *buckt = (buckets *) malloc(sizeof(struct buckets) * 10); // aloca espaço para criar a lista de vertices
